...
thread1_init:
   INSTALL SONAME 'file_key_management' ; CREATE SCHEMA birth ; init_m1_m2_m3_m4 create_many_tables ;
...
init_m1_m2_m3_m4:
   { $c_refresh = time(); $b_refresh = time() + 30; $m1 = ''; $m2 = '' ; $m3 = ''; $m4 = '' ; return undef } ;
flip_m1_m2:
   { if ($c_refresh + 60 < time()) { $c_refresh = time(); $m1 = ''; $m2 = '' } else { $m1 = '/*'; $m2 = '*/' } ; return undef } ;
flip_m3_m4:
   { if ($b_refresh + 60 < time()) { $b_refresh = time(); $m3 = ''; $m4 = '' } else { $m3 = '/*'; $m4 = '*/' } ; return undef } ;
...
thread1:
   ...
   query                                                                    |
   query                                                                    |
   flip_m1_m2 recreate_cool_down ; move_to_cool_down ; create_table         |
   flip_m3_m4 $m3 SET GLOBAL innodb_buffer_pool_size = buffer_pool_size $m4 ;
...
move_to_cool_down:
   $m1 m_t_c $m2 ; $m1 m_t_c $m2 ; $m1 m_t_c $m2 ; $m1 m_t_c $m2 ; $m1 m_t_c $m2 ; $m1 m_t_c $m2 ; $m1 m_t_c $m2 ; $m1 m_t_c $m2 ; $m1 m_t_c $m2 ; $m1 m_t_c $m2 ;
m_t_c:
   set_table_names RENAME TABLE $parent TO cool_down . { $ntab = $prefix . "_p" }, $child TO cool_down . { $ntab = $prefix . "_c" } ;
...
create_table:
   DROP TABLE IF EXISTS birth . child , birth . parent ; create_parent ; create_child ; move_to_test ;
...
set_table_names:
   prefix { $parent = "test . t" . $prefix . "_p" ; $child = "test . t" . $prefix . "_c" ; return undef } ;

prefix:
    { $prefix = 1 ; return undef } |
    { $prefix = 2 ; return undef } |
    { $prefix = 3 ; return undef } |
    { $prefix = 4 ; return undef } |
    { $prefix = 5 ; return undef } |
    { $prefix = 6 ; return undef } |
    { $prefix = 7 ; return undef } |
    { $prefix = 8 ; return undef } |
    { $prefix = 9 ; return undef } |
    { $prefix = 10 ; return undef } ;

table_names:
# Make it possible to use the same table_name multiple times in one query.
# This is currently not exploited.
   set_table_names $parent |
   set_table_names $child  ;
